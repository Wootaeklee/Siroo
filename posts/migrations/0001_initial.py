    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_vil', models.ManyToManyField(blank=True, related_name='vil_post', to='posts.Vil')),
                ('taginpost', models.ManyToManyField(blank=True, related_name='taged_post', to='posts.Tag')),
